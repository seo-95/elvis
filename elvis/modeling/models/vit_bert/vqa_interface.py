...
from .dispatcher import VIT_BERT_INTERFACE_REGISTRY


class VITBERTVQADataInterface(ModelDataInterface):
...
@VIT_BERT_INTERFACE_REGISTRY.register()
def build_vqa_interface(cfg, tokenizer, ans2id):
    return VITBERTVQADataInterface(max_tokens=cfg.MAX_N_TOKENS,
                                   tokenizer=tokenizer,
                                   ans2id=ans2id)
